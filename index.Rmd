...
1. Nilsson J, **Barrett LT**, Mangor-Jensen A, Nola V, Harboe T, Folkedal O (In press) Effect of water temperature and exposure duration on detachment rate of salmon lice (*Lepeophtheirus salmonis*); testing the relevant thermal spectrum used for delousing. *Aquaculture*.

1. Lennox RJ, **Barrett LT**, Nilsen C, Berhe S, Barlaup B, Vollset KW (In press) Moving cleaner fish from the wild into fish farms: a zero-sum game? *Ecological Modelling*.
