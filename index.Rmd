...
1. Macaulay G, **Barrett LT**, Dempster T (In press) Recognising trade-offs between welfare and environmental outcomes in aquaculture will enable good decisions. *Aquaculture Environment Interactions*. [**email for pdf**](luke.barrett@unimelb.edu.au)
...
1. Wilson S, Fulton C, Graham N, Abesamis R, Berkström C, Coker D, Depczynski M, Evans R, Fisher R, Goetze J, Hoey A, Holmes T, Kulbicki M, Noble M, Robinson J, Bradley M, Åkerlund C, **Barrett LT**, Birt M, Bucol A, Chacin D, Chong-Seng K, Eggertsen L, Eggertsen M, Ellis D, Leung P; Lam P; van Lier J; Matis P, Pérez-Matus A, Piggott C, Radford B, Tano S, Tinkler P (In Press) The contribution of macroalgal associated fishes to small-scale tropical reef fisheries. [*Fish and Fisheries*](http://doi.org/10.1111/faf.12653). [**email for pdf**](luke.barrett@unimelb.edu.au)
