...
## Publications
******
1. **Barrett LT**, Unneland Larsen L-T, Bui S, Vågseth T, Eide E, Dempster T, Oppedal F, Folkedal O (In press) Post-smolt Atlantic salmon can regulate buoyancy in submerged sea-cages by gulping air bubbles. *Aquacultural Engineering*. [**email for pdf**](l.barrett@deakin.edu.au)

1. Oppedal F, **Barrett LT**, Fraser TWK, Vågseth T, Zhang G, Andersen OG, Jacson L, Dieng M-A, Vindas MA (In press) The behavioral and neurobiological response to sound stress in salmon. *Brain, Behavior and Evolution*. [**email for pdf**](l.barrett@deakin.edu.au)
